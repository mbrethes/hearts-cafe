...
/*! 
	...
	This file contains all math related stuff. It has a couple of constants, fixed 
	point macros, precalculated sine and cosine tables, a pseudo random number
	generator and some math functions.
...
/*!
	...
	If you change this macro, then an assertion is triggered during compilation of
	the \a SoSystem.c file to remind you about this.
*/
...
#define SoMathSqrt SO_DEPRECATED_FUNCTION(SoMathSqrt, use_SoMathFixedSqrt)


// --------------------------------------------------------------------------------------
// Functions implemented in asm;
// Sadly, these need to be documented in here, cause Doxygen can't handle .s files very
// well.
// --------------------------------------------------------------------------------------
/*!
