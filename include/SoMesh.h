...
/*! 
	...
	If this is not enough, you might want to increase it, but remember this is a Gameboy 
	Advance we're talking about. You might even want to scale it down a bit if you 
	only use fairly simple meshes.

	This value is used by the camera module to know the maximum size for the vertex 
	buffers. 
*/
...
/*!
	...
	Check the attributes and the methods for more information. However, these attributes
	are private. Under normal circumstances you'll only need the \a SoMesh methods. 
