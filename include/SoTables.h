...
/*!
	...
	I use a table for fast (1 / N) calculations. Obviously we cannot make this 
	table too big. Because we want a bit more precision we allow this indexed-division
	to have a couple of bits for the fraction. That is defined by the following 
	value. The table is SO_ONE_OVER_N_MAX_N times 2^SO_ONE_OVER_N_INDEX_Q times
	4 bytes big.
