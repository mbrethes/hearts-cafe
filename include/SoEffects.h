...
/*! 
	...
	Alpha blending allows processing for 16 levels of semi-transparency performing
	arithmetic operations on 2 selected layers.
	...
	See the Pern Project (http://www.thepernproject.com) or other Nintendo references
	...
	\note	In case of alpha blending, the 2 surfaces you're targeting must have meaningfull 
			priorities. 

	\warning To use effects, you have to specify the window usage of these effects. Cause 
			 ...
			 \endcode
			 And everything will work. You don't even have to enable the window itself. Just
			 make sure you enable effects for at least one window.

	\todo	Provide some higherlevel functions too, or some examples.
