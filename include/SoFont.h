...
/*! 
	...
	This module is for all font handling, it's rather primitive at the moment, but
	in the future this will change.

	A default font is also implemented in this file, but this does not mean
	that you should define other fonts here too. You can define them anywhere, just include
	this file (\a SoFont.h) and off you go.
