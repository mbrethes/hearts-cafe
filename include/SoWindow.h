...
/*! 
	...
	The GBA can display 2 windows simultaneously allowing you to select a rectangular
	portion of the screen. The selected portions can be used to control which parts of
	the screen colors special effects and scrolling are applied and which layers
	can be seen through the windows.

	\note Window 0 has a higher display priority than window 1.

	Make sure you enable a window by using \a SoWindowSet0Enable or \a SoWindowSet1Enable 
	cause otherwise you can do all you want but you won't see a difference.
