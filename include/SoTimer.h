...
/*! 
	...
	At the moment this module contains a clock and a wait-routine. It also contains
	some functions to setup timers for using them together with the \a SoSound module.
