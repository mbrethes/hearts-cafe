...
/*!
	...
	This is used by the \a SoCamera module in the clipping routine. We use a fixed
	size array to hold clipped vertices, and make sure we never exceed this maximum
	number. Which shouldn't be much of a problem, since you should be using triangles
	anyway.
*/
...
/*!
	...
	Note that all its attributes are private. Use the \a SoPolygon methods
	to act upon these attributes.
*/
typedef struct 
{
